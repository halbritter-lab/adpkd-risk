...
export default {
    lineChart: {
      ...
      propkdRiskSchemes: {
        ...
        lowRisk: {
          class1A: { backgroundColor: 'rgba(196, 214, 145, 0.5)', borderColor: 'rgba(255, 204, 153, 0.5)' },
          class1B: { backgroundColor: 'rgba(255, 255, 204, 0.5)', borderColor: 'rgba(253, 253, 177, 0.5)' },
          class1C: { backgroundColor: 'rgba(252, 227, 178, 0.5)', borderColor: 'rgba(255, 217, 163, 0.5)' },
          class1D: { backgroundColor: 'rgba(255, 187, 153, 0.5)', borderColor: '#ffc000' },
          class1E: { backgroundColor: 'rgba(255, 139, 136, 0.5)', borderColor: '#ff6600' },
        },
        highRisk: {
          class1A: { backgroundColor: 'rgba(123, 214, 145, 0.5)', borderColor: 'rgba(255, 180, 204, 0.5)' },
          class1B: { backgroundColor: 'rgba(190, 253, 150, 0.5)', borderColor: 'rgba(253, 217, 217, 0.5)' },
          class1C: { backgroundColor: 'rgba(252, 117, 178, 0.5)', borderColor: 'rgba(245, 217, 163, 0.5)' },
          class1D: { backgroundColor: 'rgba(255, 187, 113, 0.5)', borderColor: '#ff0000' },
          class1E: { backgroundColor: 'rgba(220, 50, 136, 0.5)', borderColor: '#ff6600' },
        },
      },
      options: {
        responsive: true,
