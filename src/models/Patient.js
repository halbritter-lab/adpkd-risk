export default class Patient {
    ...
    calculateHtTKV() {
        ...
        // Calculate Mayo class based on HtTKV
    ...
    // Method to get Mayo Class based on TKV
    getMayoClass(htAdjustedTKV) {
      if (htAdjustedTKV < 233.695) return 'low';
      if (htAdjustedTKV < 290.292) return 'intermediate';
      if (htAdjustedTKV < 359.484) return 'high';
      return 'very high';
    }
